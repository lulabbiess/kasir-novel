...
<div class="navbar">
  ...
  <div class="dropdown" style="float: right; margin-right: 60px;">
    ...
    <button type="submit" class="btn" onclick="seongmin()">Logout</button>
    <p id="demo"></p>
...
<h2>DATA PRODUK</h2>
<td><button type="text"> <a href="inputbarang.html">Tambah Produk</a></button></td><br>
</br>
...
<table id="myTable">
 ...
 <div class="tengah">
        ...
        <tbody>
        <?php
        while ($editproduk = mysqli_fetch_assoc($data)) {
        ?>
        <tr>
        <td><?php echo $editproduk ['NamaProduk']; ?></td>
        <td>Rp.<?php echo $editproduk['Harga']; ?></td>
        <td><?php echo $editproduk['Stok']; ?> <?php echo $editproduk['Keterangan']; ?></td>
        <td><button type="text"> <a href="editproduk.php?id=<?php echo $editproduk['ProdukID']; ?>"><i class="fa  fa-pencil-square-o"></i></button></td>
        <td><button type="text"> <a href="hapusproduk.php?id=<?php echo $editproduk['ProdukID']; ?>"><i class="fa  fa-trash"></i></button></td>
