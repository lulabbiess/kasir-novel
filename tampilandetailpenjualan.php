...
<div class="navbar">
  ...
  <div class="dropdown" style="float: right; margin-right: 60px;">
    ...
    <button type="submit" class="btn" onclick="jimin()">Logout</button>
    <p id="demo"></p>
...
<td><button type="text"> <a href="formdetailpenjualan.php">Tambah detail penjualan</a></button><br>
</br>
...
<table id="myTable">
 ...
 <div class="tengah">
        ...
        <td><?php echo $detailpenjualan['Subtotal']; ?></td>
        <td><button type="text"> <a href="editdetailpenjualan.php?id=<?php echo $detailpenjualan['PenjualanID']; ?>"><i class="fa  fa-pencil-square-o"></i></button></td>
